...
def build_optimizer(
    ...
    *,
    ...
    if name == "sgd":
        return SGD(parameters, learning_rate=learning_rate)
    if name == "momentum":
...
def run_training_loop(
    ...
    *,
    ...
    """Run a deterministic full-batch training loop and collect diagnostics."""
...
def run_regression_experiment(
    ...
    *,
    ...
    """Train a small scalar-output MLP regression experiment reproducibly."""
