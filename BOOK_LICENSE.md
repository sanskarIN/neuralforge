...
Copyright 2026 Ram Sandesh. All rights reserved.

The MIT License in this repository applies to original companion **software code** unless a file says otherwise. It does **not** automatically apply to the NeuralForge ebook manuscript, PDF/EPUB/DOCX publication files, book layout, cover, exercises, explanations, diagrams, tables, or other publication assets.
